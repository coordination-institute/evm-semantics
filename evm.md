...
```k
    ...
    rule <k> #gas [ SCHED , EXTCODECOPY V1 START V2 WIDTH ] => #gasMemory(START, WIDTH) ~> Gverylow     < SCHED > +Int (Gcopy < SCHED > *Int (WIDTH up/Int 32)) ~> #deductGas ... </k>
    ...
    rule <k> #gas [ SCHED , RETURNDATACOPY START V2 WIDTH ] => #gasMemory(START, WIDTH) ~> Gextcodecopy < SCHED > +Int (Gcopy < SCHED > *Int (WIDTH up/Int 32)) ~> #deductGas ... </k>
